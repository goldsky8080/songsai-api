...
const envSchema = z.object({
  ...
  PORTONE_API_SECRET: emptyStringToUndefined,
  PORTONE_STORE_ID: emptyStringToUndefined,
  PORTONE_CHANNEL_KEY: emptyStringToUndefined,
  PORTONE_WEBHOOK_SECRET: emptyStringToUndefined,
  STRIPE_SECRET_KEY: emptyStringToUndefined,
  STRIPE_WEBHOOK_SECRET: emptyStringToUndefined,
  STRIPE_CHECKOUT_SUCCESS_URL: emptyStringToUndefined,
  STRIPE_CHECKOUT_CANCEL_URL: emptyStringToUndefined,
  STRIPE_PRICE_CREDIT_110: emptyStringToUndefined,
  STRIPE_PRICE_CREDIT_350: emptyStringToUndefined,
  STRIPE_PRICE_CREDIT_590: emptyStringToUndefined,
...
export function getEnv() {
  ...
  const parsedEnv = envSchema.parse({
    ...
    STRIPE_PRICE_CREDIT_110: process.env.STRIPE_PRICE_CREDIT_110,
    STRIPE_PRICE_CREDIT_350: process.env.STRIPE_PRICE_CREDIT_350,
    STRIPE_PRICE_CREDIT_590: process.env.STRIPE_PRICE_CREDIT_590,
